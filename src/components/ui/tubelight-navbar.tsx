...
export function NavBar({ items, className, onItemClick, forceDark }: NavBarProps) {
  ...
  return (
    <>
      <div className={cn("fixed top-6 left-1/2 -translate-x-[60%] sm:left-8 sm:-translate-x-0 ipad-pro-nav-adjust lg:left-1/2 lg:-translate-x-1/2 z-50 w-max max-w-[95vw]", forceDark && "dark", className)}>
